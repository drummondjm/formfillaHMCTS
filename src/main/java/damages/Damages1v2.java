...
public class Damages1v2 {
    public static void main(String[] args) {
...

        {
            ...
            // Click text=Continue
            // page.waitForNavigation(new Page.WaitForNavigationOptions().setUrl("http://localhost:3333/cases/case-create/CIVIL/CIVIL/CREATE_CLAIM/CREATE_CLAIMSecondDefendant"), () ->
            page.waitForNavigation(() -> {
                page.click("text=Continue");
            });
            // Click #respondent1_individual
            ...
            // Press Tab
            page.press("#respondent2_primaryAddress__detailPostCode", "Tab");

            // Click text=Continue
            // page.waitForNavigation(new Page.WaitForNavigationOptions().setUrl("http://localhost:3333/cases/case-create/CIVIL/CIVIL/CREATE_CLAIM/CREATE_CLAIMSecondDefendantLegalRepresentation"), () ->
            page.waitForNavigation(() -> {
                page.click("text=Continue");
            });

            // Click input[name="respondent2Represented"]
            page.click("input[name=\"respondent2Represented\"]");
            // Click button:has-text("Continue")

            // page.waitForNavigation(new Page.WaitForNavigationOptions().setUrl("http://localhost:3333/cases/case-create/CIVIL/CIVIL/CREATE_CLAIM/CREATE_CLAIMSameLegalRepresentative"), () ->
            page.waitForNavigation(() -> {
