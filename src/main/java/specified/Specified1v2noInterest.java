...
public class Specified1v2noInterest {
    public static void main(String[] args) {
...

        {
            ...
            // Click #addRespondent2_Yes
            page.click("#addRespondent2_Yes");

            // Click text=Continue
            // page.waitForNavigation(new Page.WaitForNavigationOptions().setUrl("http://localhost:3333/cases/case-create/CIVIL/CIVIL/CREATE_CLAIM_SPEC/CREATE_CLAIM_SPECSecondDefendant"), () ->
            page.waitForNavigation(() -> {
                page.click("text=Continue");
            });
            ...
            // Click #respondent1_individual
            page.click("#respondent2_type-INDIVIDUAL");

            // Click #respondent1_individualFirstName
            page.click("#respondent2_individualFirstName");

            // Fill #respondent1_individualFirstName
            page.fill("#respondent2_individualFirstName", "Edward");

            // Press Tab
            page.press("#respondent2_individualFirstName", "Tab");

            // Fill #respondent1_individualLastName
            page.fill("#respondent2_individualLastName", "Smith");

            // Press Tab
            page.press("#respondent2_individualLastName", "Tab");
            ...
            // Fill text=Building and StreetAddress Line 2 (Optional)Address Line 3 (Optional)Town or Cit >> input[type="text"]
            page.fill("text=Building and StreetAddress Line 2 (Optional)Address Line 3 (Optional)Town or Cit >> input[type=\"text\"]", "Respondent2 fake address");

            // Click #respondent2_primaryAddress__detailPostCode
            page.click("#respondent2_primaryAddress__detailPostCode");

            // Fill #respondent2_primaryAddress__detailPostCode
            page.fill("#respondent2_primaryAddress__detailPostCode", "WC1N 2LD");


            // Click text=Continue
            // page.waitForNavigation(new Page.WaitForNavigationOptions().setUrl("http://localhost:3333/cases/case-create/CIVIL/CIVIL/CREATE_CLAIM_SPEC/CREATE_CLAIM_SPECLegalRepresentationRespondent2"), () ->
            page.waitForNavigation(() -> {
                page.click("text=Continue");
            });

            // Click input[name="specRespondent2Represented"]
            page.click("input[name=\"specRespondent2Represented\"]");

            // Click text=Continue
            // page.waitForNavigation(new Page.WaitForNavigationOptions().setUrl("http://localhost:3333/cases/case-create/CIVIL/CIVIL/CREATE_CLAIM_SPEC/CREATE_CLAIM_SPECSameLegalRepresentative"), () ->
            page.waitForNavigation(() -> {
                page.click("text=Continue");
            });

            // Click input[name="respondent2SameLegalRepresentative"]
            page.click("input[name=\"respondent2SameLegalRepresentative\"]");
